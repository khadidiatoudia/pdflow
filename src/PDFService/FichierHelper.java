...
abstract public class FichierHelper
{
  private static String  _id = "IDL:PDFService/Fichier:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (PDFService.FichierHelper.id (), "Fichier", __typeCode);
    }
    return __typeCode;
  }
